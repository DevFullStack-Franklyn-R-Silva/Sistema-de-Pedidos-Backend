...
public class DBService {
	...
	public void instantieteTestDatabase() throws ParseException {
		...
		Cliente cli1 = new Cliente(null, "Maria Silva", "franklyn1998@gmail.com", "49247627095",
				TipoCliente.PESSOAFISICA, passwordEncoder.encode("123"));

		Cliente cli2 = new Cliente(null, "Ana Costa", "franklyn.silva@arapiraca.ufal.br", "66684662065", TipoCliente.PESSOAFISICA,
				passwordEncoder.encode("123"));

		cli2.addPerfil(Perfil.ADMIN);
		
		cli1.getTelefones().addAll(Arrays.asList("999983658", "912365248"));
		cli2.getTelefones().addAll(Arrays.asList("999123456", "985462525"));

		Endereco e1 = new Endereco(null, "Rua Flores", "300", "Apto 203", "Jardim", "38220834", cli1, c1);
		Endereco e2 = new Endereco(null, "Avenida Matos", "105", "Sala 800", "Centro", "38777012", cli1, c2);
		Endereco e3 = new Endereco(null, "Avenida Floriano", "2106", null, "Centro", "57309801", cli2, c2);
